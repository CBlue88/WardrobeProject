...
namespace WardrobeProject.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoriesID,Name,Photo,Color,Season,Occasion")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoriesID,Name,Photo,Color,Season,Occasion")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
